...
namespace CNSSERP.DAL.Migrations
{
    ...
    [Migration("20160828230738_29082016001LS")]
    partial class _29082016001LS
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Purchase.Purchase_documents", b =>
                {
                    ...
                    b.Property<string>("CustomersRefId")
                        .IsRequired();
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Sales.Customers", b =>
                {
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Purchase.Purchase_documents", b =>
                {
                    b.HasOne("CNSS_ERP.DAL.Models.Sales.Customers", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomersRefId")
