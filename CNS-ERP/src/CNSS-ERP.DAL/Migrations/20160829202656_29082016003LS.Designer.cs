...
namespace CNSSERP.DAL.Migrations
{
    ...
    [Migration("20160829202656_29082016003LS")]
    partial class _29082016003LS
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Sales.Contractors", b =>
                {
                    ...
                    b.ToTable("ContractorsDbSet");
                });

            modelBuilder.Entity("CNSS_ERP.DAL.Models.Sales.Invoice_posiotions", b =>
                {
                    b.Property<int>("Invoice_posiotionsId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("Sales_invoicesRefId")
                        .IsRequired();
                    ...
                    b.HasKey("Invoice_posiotionsId");

                    b.HasIndex("ProductsRefId");

                    b.HasIndex("Sales_invoicesRefId");

                    b.HasIndex("Tax_ratesRefId");

                    b.HasIndex("UnitsRefId");

                    b.ToTable("Invoice_posiotionsDbSet");
                });
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Storage.ProductImages", b =>
                {
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Storage.ProductStorages", b =>
                {
                    ...
                    b.HasKey("ProductStoragesId");

                    b.HasIndex("ProductsRefId");

                    b.HasIndex("UnitsRefId");

                    b.ToTable("ProductStoragesDbSet");
                });
            ...
            modelBuilder.Entity("CNSS_ERP.DAL.Models.Sales.Invoice_posiotions", b =>
                {
                    ...
                    b.HasOne("CNSS_ERP.DAL.Models.Sales.Sales_invoices", "Sales_invoice")
                        .WithMany()
                        .HasForeignKey("Sales_invoicesRefId")
                        .OnDelete(DeleteBehavior.Cascade);
